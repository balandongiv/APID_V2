...
This session helps you select the best concept(s) for development. Define selection criteria from needs, specifications, and enterprise factors; build a concept-screening matrix using a datum concept; interpret results; and decide whether detailed concept scoring is needed.
\end{tcolorbox}
...
Derive criteria from customer needs, product specifications, and enterprise concerns. Include physics-related suitability, such as sensor accuracy or structural stability, where relevant.
\end{tcolorbox}
...
Complete the concept-screening matrix by selecting a datum concept and rating each alternative using +, 0, or -- for each criterion. Tally pluses and minuses to identify the strongest options.
\end{tcolorbox}
...
Do not base final decisions only on intuition. Use screening evidence to see strengths and trade-offs, and avoid discarding concepts too early without considering critical user needs. If results are close, use weighted scoring.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Checkpoint]
Ensure you produce a documented shortlist of concepts, together with a clear rationale for why concept scoring was or was not performed. This justification is needed to plan concept testing in Session 12.
\end{tcolorbox}
