...
\section{Session Overview: YET TO BENCHMARK AGAINST LAST SEM TUTORIAL}
...
Your final preparatory task is to design a concept test. Decide what you need to learn, choose an appropriate survey population and sample-size approach, select a survey format, draft evaluation questions, and determine how to communicate your concept.
\end{tcolorbox}
...
Select respondents who resemble your target market, have enough experience to evaluate the concept, and match the product's price and maintenance expectations. Even a small sample can yield useful insight when selected thoughtfully.
\end{tcolorbox}
...
Complete the planning template with purpose, target segment, survey population, sample-size approach, survey format, evaluation questions, and communication method. Verify each field is filled before finalising the plan.
\end{tcolorbox}
...
Do not choose a high-effort communication method if a simpler method is enough. Match communication fidelity to concept complexity and available time, and avoid surveying people outside your target market only for convenience.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Hint]
When collecting feedback, explain the survey purpose clearly, respect respondents' time, and avoid unnecessary personal data collection. Keep records of the final plan, final questions, and rationale for your choices.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Checkpoint]
Ensure your team agrees on the final concept-test plan and that all details (purpose, population, format, questions, and communication method) are documented for concept refinement and final reporting.
\end{tcolorbox}
