...
Summarise today's mission: identify a specific hydroponic product opportunity and select a plausible company context. Focus on opportunities that solve a meaningful hydroponics problem, provide enough technical depth for later physics analysis, and fit within your team's capability.
\end{tcolorbox}
...
Avoid generic or loosely related ideas. Your product must have a clear and defensible connection to hydroponics and enough technical depth for applied physics work. Do not choose an idea simply because it seems trendy; evaluate need, feasibility, user impact, physics relevance, and team capability.
\end{tcolorbox}
...
\input{session1/example_hydroponic.tex}
...
Brainstorm both direct products (for example nutrient mixers, pumps, and monitoring sensors) and indirect products (for example maintenance tools or storage units). If you struggle to decide, do a quick market scan to see what products already exist and how your idea could be differentiated.
\end{tcolorbox}
...
Before moving on, ensure that your team has selected a product, stated the specific hydroponics problem it solves, and documented why this idea was preferred over other candidates. Capture this in point form for ITEL submission.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Checkpoint]
Confirm your chosen company type (established company or start-up) and record your reasoning with respect to target users, resources, quality level, market position, and price strategy. This context will influence manufacturing and market analysis later.
\end{tcolorbox}
