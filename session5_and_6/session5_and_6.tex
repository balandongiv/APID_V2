...
In Session 5, each member will conduct a market analysis for the selected hydroponic product and draft a mission statement. Identify market segments, technologies, manufacturing and service constraints, target market and price, assumptions, constraints, and stakeholders.
\end{tcolorbox}
...
Do not limit your thinking to user demographics. Consider physical behaviours such as flow stability, corrosion resistance, thermal exposure, and sensor accuracy, and how these influence technology choices. Use credible sources and note assumptions or uncertainties.
\end{tcolorbox}
...
Complete all rows in the market analysis table and include sources or notes for each entry. Without a thorough analysis, your mission statement will lack a strong foundation.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Hint]
A strong mission statement includes a concise product description, benefit proposition, key business goals, primary and secondary markets, assumptions and constraints, and stakeholders. Keep the language clear and actionable.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Checkpoint]
Draft your mission statement and verify it contains all seven fields in the template. Keep it short and precise, and avoid fixing technical solutions at this stage.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Goal]
In Session 6, your team will merge individual analyses into one shared plan and mission statement. Agree on market segments, technology opportunities, manufacturing and service considerations, target market and price, assumptions and constraints, and stakeholders.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Checkpoint]
Record the final consensus for each planning element and cite evidence or rationale. Ensure all voices are heard and unresolved disagreements are noted. This table will guide Sessions 7 and 8.
\end{tcolorbox}
...
Avoid mission statements that are too vague or too ambitious for the course. Check that your mission is consistent with the innovation charter and shortlisted opportunity, includes realistic assumptions and constraints, and provides enough technical direction for customer-needs analysis.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Hint]
Use your final mission statement as a touchstone in later sessions. When specifying needs, metrics, functions, concepts, and tests, continuously check whether your choices support this mission.
\end{tcolorbox}
