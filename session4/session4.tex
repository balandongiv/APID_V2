...
In this session, convert your innovation charter into several concrete opportunities. Generate at least five options that fit the charter, describe how each could create value for hydroponic users, and prepare to screen them using objective criteria.
\end{tcolorbox}
...
Refer back to your innovation charter to stay within scope. Think beyond obvious improvements by considering user frustrations, technical issues (flow, sensing, maintenance, energy), safety, efficiency, reliability, usability, and emerging technologies.
\end{tcolorbox}
...
Before class, each team member should have at least five opportunities recorded using the template fields: description, charter alignment, expected value, and physics or technical focus.
\end{tcolorbox}
...
Do not fixate on one idea too early. Explore the design space broadly, avoid ideas outside your charter, and remove options that lack technical depth or are not feasible within the course.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Checkpoint]
Complete the screening matrix using a 1--5 scale for alignment, impact, feasibility, technical depth, and resource fit. Retain opportunities that score well on most criteria, and record why others were discarded.
\end{tcolorbox}
