...
Your task today is to draft and agree on an innovation charter for your project. A strong charter identifies the problem area, product category, target users, and time frame, stays within hydroponics, leaves room for multiple opportunities, supports applied-physics analysis, and remains achievable.
\end{tcolorbox}
...
Notice how the sample charters identify a category, intended users, and a time frame. Use this pattern as inspiration when drafting your own statements.
\end{tcolorbox}
...
Avoid writing a charter that already fixes the exact mechanism, geometry, or final concept. Equally, avoid vague goals such as "make hydroponics better"; include the product category, target market, and time frame.
\end{tcolorbox}
...
Ensure you bring at least two draft charters to class, each with a one-line note explaining why it is promising. Without these drafts, in-class comparison cannot proceed effectively.
\end{tcolorbox}
...
\begin{tcolorbox}[title=Checkpoint]
After discussion, write the final charter agreed by the team, check it against relevance, breadth, feasibility, physics connection, and impact criteria, and record the rationale for selection.
\end{tcolorbox}
